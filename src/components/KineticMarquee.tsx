            ...
            {chip && obj ? (
              to ? (
                <a
                  ...
                  title={label}
                  className="mx-2 block shrink-0 border border-ink-500 bg-plate px-3 py-1.5 transition-transform duration-200 hover:scale-105"
                >
                  <img
                    src={chip}
                    alt={label}
                ...
                <span title={label} className="mx-2 block shrink-0 border border-ink-500 bg-plate px-3 py-1.5">
                  <img
                    src={chip}
                    alt={label}
                    loading="eager"
